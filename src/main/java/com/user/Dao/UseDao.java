...
public class UseDao {
    ...
    // Added SQL query for verifying user credentials
    ...
    // Modified method to verify user credentials and return user object if valid
    public User verifyUser(String email, String password) {
        ...
        return user; // Return user object if valid, otherwise null
    }
}
